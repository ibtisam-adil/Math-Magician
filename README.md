...
This project builds upon the core functionality of the previously developed Calculator component to create a comprehensive website consisting of three distinct pages: Home, Calculator, and Quote. The primary aim is to demonstrate proficiency in React development, including routing and page integration.
...
[@my portfolio app](https://ibtisam-calculator-app.netlify.app)
...
`git clone https://github.com/ibtisam-adil/mathmagicians.git`
